...
const Summary: React.FC<SummaryProps> = ({ orders, products }) => {
  ...
  // get summaryKey as an array then map through(Object.keys() returns an array of keys, not the values themselves. console.log(summaryKeys); // Output: ["sale", "products", "orders"])
